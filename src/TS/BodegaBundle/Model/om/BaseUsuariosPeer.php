...
use \PropelException;
use \PropelPDO;
use TS\BodegaBundle\Model\Usuarios;
use TS\BodegaBundle\Model\UsuariosPeer;
use TS\BodegaBundle\Model\map\UsuariosTableMap;
...
abstract class BaseUsuariosPeer
{
    ...
    const OM_CLASS = 'TS\\BodegaBundle\\Model\\Usuarios';

    /** the related TableMap class for this table */
    const TM_CLASS = 'TS\\BodegaBundle\\Model\\map\\UsuariosTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Nombre', 'Password', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombre', 'password', ),
        BasePeer::TYPE_COLNAME => array (UsuariosPeer::ID, UsuariosPeer::NOMBRE, UsuariosPeer::PASSWORD, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOMBRE', 'PASSWORD', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'nombre', 'password', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nombre' => 1, 'Password' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombre' => 1, 'password' => 2, ),
        BasePeer::TYPE_COLNAME => array (UsuariosPeer::ID => 0, UsuariosPeer::NOMBRE => 1, UsuariosPeer::PASSWORD => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOMBRE' => 1, 'PASSWORD' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre' => 1, 'password' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuariosPeer::PASSWORD);
        } else {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUsuariosPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \TS\BodegaBundle\Model\map\UsuariosTableMap());
      }
    }
