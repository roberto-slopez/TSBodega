...
abstract class BaseUsuarios extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'TS\\BodegaBundle\\Model\\UsuariosPeer';
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = UsuariosPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsuariosPeer::PASSWORD)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuariosPeer::PASSWORD)) $criteria->add(UsuariosPeer::PASSWORD, $this->password);
