...
use TS\BodegaBundle\Model\UsuariosQuery;
 ...
 * @method UsuariosQuery orderByPassword($order = Criteria::ASC) Order by the password column
 *
 * @method UsuariosQuery groupById() Group by the id column
 * @method UsuariosQuery groupByNombre() Group by the nombre column
 * @method UsuariosQuery groupByPassword() Group by the password column
 *
 ...
 * @method Usuarios findOneByPassword(string $password) Return the first Usuarios filtered by the password column
 *
 ...
 * @method array findByPassword(string $password) Return Usuarios objects filtered by the password column
 */
abstract class BaseUsuariosQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'TS\\BodegaBundle\\Model\\Usuarios';
        }
    ...
    {
        $sql = 'SELECT `id`, `nombre`, `password` FROM `usuarios` WHERE `id` = :p0';
        try {
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(UsuariosPeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(UsuariosPeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByPassword($password = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UsuariosPeer::PASSWORD, $password, $comparison);
    }
