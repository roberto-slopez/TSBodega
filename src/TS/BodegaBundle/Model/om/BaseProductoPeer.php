...
use TS\BodegaBundle\Model\map\ProductoTableMap;
...
abstract class BaseProductoPeer
{
    ...
    const OM_CLASS = 'TS\\BodegaBundle\\Model\\Producto';

    /** the related TableMap class for this table */
    const TM_CLASS = 'TS\\BodegaBundle\\Model\\map\\ProductoTableMap';
    ...
    public static function doCountJoinCategoria(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ProductoPeer::CATEGORIA_ID, CategoriaPeer::ID, $join_behavior);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseProductoPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \TS\BodegaBundle\Model\map\ProductoTableMap());
      }
    }
