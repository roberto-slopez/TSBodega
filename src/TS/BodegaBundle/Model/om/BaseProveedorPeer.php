...
use TS\BodegaBundle\Model\map\ProveedorTableMap;
...
abstract class BaseProveedorPeer
{
    ...
    const OM_CLASS = 'TS\\BodegaBundle\\Model\\Proveedor';

    /** the related TableMap class for this table */
    const TM_CLASS = 'TS\\BodegaBundle\\Model\\map\\ProveedorTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Nombre', 'Encargado', 'Nit', 'Dpi', 'Direccion', 'Telefono', 'Movil', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombre', 'encargado', 'nit', 'dpi', 'direccion', 'telefono', 'movil', ),
        BasePeer::TYPE_COLNAME => array (ProveedorPeer::ID, ProveedorPeer::NOMBRE, ProveedorPeer::ENCARGADO, ProveedorPeer::NIT, ProveedorPeer::DPI, ProveedorPeer::DIRECCION, ProveedorPeer::TELEFONO, ProveedorPeer::MOVIL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOMBRE', 'ENCARGADO', 'NIT', 'DPI', 'DIRECCION', 'TELEFONO', 'MOVIL', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'nombre', 'encargado', 'nit', 'dpi', 'direccion', 'telefono', 'movil', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nombre' => 1, 'Encargado' => 2, 'Nit' => 3, 'Dpi' => 4, 'Direccion' => 5, 'Telefono' => 6, 'Movil' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombre' => 1, 'encargado' => 2, 'nit' => 3, 'dpi' => 4, 'direccion' => 5, 'telefono' => 6, 'movil' => 7, ),
        BasePeer::TYPE_COLNAME => array (ProveedorPeer::ID => 0, ProveedorPeer::NOMBRE => 1, ProveedorPeer::ENCARGADO => 2, ProveedorPeer::NIT => 3, ProveedorPeer::DPI => 4, ProveedorPeer::DIRECCION => 5, ProveedorPeer::TELEFONO => 6, ProveedorPeer::MOVIL => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOMBRE' => 1, 'ENCARGADO' => 2, 'NIT' => 3, 'DPI' => 4, 'DIRECCION' => 5, 'TELEFONO' => 6, 'MOVIL' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre' => 1, 'encargado' => 2, 'nit' => 3, 'dpi' => 4, 'direccion' => 5, 'telefono' => 6, 'movil' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProveedorPeer::ENCARGADO);
            $criteria->addSelectColumn(ProveedorPeer::NIT);
            $criteria->addSelectColumn(ProveedorPeer::DPI);
            ...
            $criteria->addSelectColumn($alias . '.encargado');
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseProveedorPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \TS\BodegaBundle\Model\map\ProveedorTableMap());
      }
    }
