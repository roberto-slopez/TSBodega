...
use TS\BodegaBundle\Model\map\InventarioTableMap;
...
abstract class BaseInventarioPeer
{
    ...
    const OM_CLASS = 'TS\\BodegaBundle\\Model\\Inventario';

    /** the related TableMap class for this table */
    const TM_CLASS = 'TS\\BodegaBundle\\Model\\map\\InventarioTableMap';
    ...
    const PRODUCTO_ID = 'inventario.producto_id';

    /** the column name for the proveedor_id field */
    const PROVEEDOR_ID = 'inventario.proveedor_id';
    ...
    const PRECIO_UNITARIO = 'inventario.precio_unitario';

    /** the column name for the neto field */
    const NETO = 'inventario.neto';

    /** the column name for the total field */
    const TOTAL = 'inventario.total';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ProductoId', 'ProveedorId', 'Fecha', 'Stock', 'PrecioUnitario', 'Neto', 'Total', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'productoId', 'proveedorId', 'fecha', 'stock', 'precioUnitario', 'neto', 'total', ),
        BasePeer::TYPE_COLNAME => array (InventarioPeer::ID, InventarioPeer::PRODUCTO_ID, InventarioPeer::PROVEEDOR_ID, InventarioPeer::FECHA, InventarioPeer::STOCK, InventarioPeer::PRECIO_UNITARIO, InventarioPeer::NETO, InventarioPeer::TOTAL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PRODUCTO_ID', 'PROVEEDOR_ID', 'FECHA', 'STOCK', 'PRECIO_UNITARIO', 'NETO', 'TOTAL', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'producto_id', 'proveedor_id', 'fecha', 'stock', 'precio_unitario', 'neto', 'total', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ProductoId' => 1, 'ProveedorId' => 2, 'Fecha' => 3, 'Stock' => 4, 'PrecioUnitario' => 5, 'Neto' => 6, 'Total' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'productoId' => 1, 'proveedorId' => 2, 'fecha' => 3, 'stock' => 4, 'precioUnitario' => 5, 'neto' => 6, 'total' => 7, ),
        BasePeer::TYPE_COLNAME => array (InventarioPeer::ID => 0, InventarioPeer::PRODUCTO_ID => 1, InventarioPeer::PROVEEDOR_ID => 2, InventarioPeer::FECHA => 3, InventarioPeer::STOCK => 4, InventarioPeer::PRECIO_UNITARIO => 5, InventarioPeer::NETO => 6, InventarioPeer::TOTAL => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PRODUCTO_ID' => 1, 'PROVEEDOR_ID' => 2, 'FECHA' => 3, 'STOCK' => 4, 'PRECIO_UNITARIO' => 5, 'NETO' => 6, 'TOTAL' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'producto_id' => 1, 'proveedor_id' => 2, 'fecha' => 3, 'stock' => 4, 'precio_unitario' => 5, 'neto' => 6, 'total' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(InventarioPeer::PRODUCTO_ID);
            $criteria->addSelectColumn(InventarioPeer::PROVEEDOR_ID);
            $criteria->addSelectColumn(InventarioPeer::FECHA);
            $criteria->addSelectColumn(InventarioPeer::STOCK);
            $criteria->addSelectColumn(InventarioPeer::PRECIO_UNITARIO);
            $criteria->addSelectColumn(InventarioPeer::NETO);
            $criteria->addSelectColumn(InventarioPeer::TOTAL);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.neto');
    ...
    public static function doCountJoinProducto(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(InventarioPeer::PRODUCTO_ID, ProductoPeer::ID, $join_behavior);
    ...
    public static function doCountJoinProveedor(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(InventarioPeer::PROVEEDOR_ID, ProveedorPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Inventario objects pre-filled with their Producto objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinProducto(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Inventario) to $obj2 (Producto)
    ...
    /**
     * Selects a collection of Inventario objects pre-filled with their Proveedor objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Inventario objects.
    ...
    public static function doSelectJoinProveedor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Inventario) to $obj2 (Proveedor)
                $obj2->addInventario($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Inventario) to the collection in $obj2 (Producto)
                $obj2->addInventario($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Inventario) to the collection in $obj3 (Proveedor)
    ...
    /**
     * Selects a collection of Inventario objects pre-filled with all related objects except Producto.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptProducto(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = InventarioPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Inventario) to the collection in $obj2 (Proveedor)
                $obj2->addInventario($obj1);
    ...
    /**
     * Selects a collection of Inventario objects pre-filled with all related objects except Proveedor.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseInventarioPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \TS\BodegaBundle\Model\map\InventarioTableMap());
      }
    }
